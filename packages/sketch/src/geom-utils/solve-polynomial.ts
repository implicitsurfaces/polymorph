import { asNum, Num, ONE, TWO, ZERO } from "../num";
...
export const SENTINELLE = asNum(1e100);
...
export function solveQuadratic(
  ...
  return [
    ifTruthyElse(c2, bNeg.add(discSqrt).div(_2a), zeroASolution),
    ifTruthyElse(c2, bNeg.sub(discSqrt).div(_2a), zeroASolution),
