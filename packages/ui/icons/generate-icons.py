...
def split_svg_group(
    input_file: Path, group_name: str, output_dir: Path, width: float, height: float
):
    """
...
def main():
    ...
    split_svg_group(
        script_dir / "tool-icons.svg", "Tools", assets_dir / "tool-icons", 32, 32
    )
    split_svg_group(
        script_dir / "input-icons.svg", "Icons", assets_dir / "input-icons", 18, 20
    )
