...
# From https://github.com/denballakh/pyimgui-stubs
# fmt: off
...
def set_next_window_size(
    width: float, height: float, condition: int = ALWAYS
) -> Any: ...
...
def set_window_collapsed_labeled(
    label: str, collapsed: bool, condition: int = ALWAYS
) -> Any: ...
...
def invisible_button(
    identifier: str, width: float, height: float, flags: Any = 0
) -> Any: ...
def image_button(
    texture_id,
    width: float,
...
def input_int3(
    label: str, value0: int, value1: int, value2: int, flags: Any = 0
) -> Any: ...
def input_int4(
...
def progress_bar(
    fraction: float, size: Any = (-FLOAT_MIN, 0), overlay: str = ""
) -> Any: ...
...
def end_tab_bar() -> Any: ...
def begin_tab_item(
    label: str, opened: Any = None, flags: Any = 0
) -> _BeginEndCombo: ...
...
def begin_popup_modal(
    title: str, visible: Any = None, flags: Any = 0
) -> _BeginEndPopupModal: ...
...
def color_edit4(
    label: str, r: float, g: float, b: float, a: float, flags: Any = 0
) -> Any: ...
def drag_float2(
    label: str,
    value0: float,
...
def push_style_color(
    variable: Any, r: float, g: float, b: float, a: float = 1.0
) -> Any: ...
...
def columns(
    count: int = 1, identifier: str | None = None, border: bool = True
) -> Any: ...
...
def set_cursor_pos(local_pos: Vec2) -> Any: ...
